...
describe('schema to model', () => {
  ...
  it('generates models for uspto with promoted anonymous schemas', () => {
    ...
    expect(models).to.eql([
      ...
      {
        description: 'performSearchBody',
        name: 'performSearchBody',
        className: 'PerformSearchBody',
        fileName: 'perform-search-body.model.ts',
        properties: [
          {
            name: 'criteria',
        ...
        imports: [],
        import:
          "import {PerformSearchBody} from './perform-search-body.model';",
        kind: 'class',
        declaration:
          "{\n  criteria: string = '*:*';\n  start?: number = 0;\n  " +
          'rows?: number = 100;\n}',
        signature: 'PerformSearchBody',
      },
      {
